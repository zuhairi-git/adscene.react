      ...
      <section id="products" className="portfolio">
        <div className="container">
          ...
          <div className="row">
            <div className="col-lg-12 d-flex justify-content-center">
              <ul id="portfolio-flters">
                ...
                <li data-filter=".filter-perfume">Perfume</li>
              </ul>
            </div>
          </div>
          ...
          <div className="row portfolio-container">
            ...
            <div className="col-lg-4 col-md-6 portfolio-item filter-perfume">
              <div className="portfolio-wrap">
                <img src="assets/img/photos/IMG_7817.jpg" className="img-fluid" alt="" />
                <div className="portfolio-info">
                  <h4>Sauvage</h4>
                  <p>Perfume</p>
                  <div className="portfolio-links">
                    <a href="assets/img/photos/IMG_7817.jpg" data-gallery="portfolioGallery" className="portfolio-lightbox" title="Perfume"><i className="bx bx-plus"></i></a>
            ...
            <div className="col-lg-4 col-md-6 portfolio-item filter-perfume">
              <div className="portfolio-wrap">
                <img src="assets/img/photos/IMG_7818.jpg" className="img-fluid" alt="" />
                <div className="portfolio-info">
                  <h4>1 Million</h4>
                  <p>Perfume</p>
                  <div className="portfolio-links">
                    <a href="assets/img/photos/IMG_7818.jpg" data-gallery="portfolioGallery" className="portfolio-lightbox" title="Perfume"><i className="bx bx-plus"></i></a>
                    <a href="portfolio-details.html" className="portfolio-details-lightbox" data-glightbox="type: external" title="Portfolio Details"><i className="bx bx-link"></i></a>
                  </div>
                </div>
              </div>
            ...
            <div className="col-lg-4 col-md-6 portfolio-item filter-product">
              <div className="portfolio-wrap">
                <img src="assets/img/photos/IMG_7819.jpg" className="img-fluid" alt="" />
                <div className="portfolio-info">
                  <h4>Glasses</h4>
                  <p>Product</p>
                  <div className="portfolio-links">
                    <a href="assets/img/photos/IMG_7819.jpg" data-gallery="portfolioGallery" className="portfolio-lightbox" title="Product"><i className="bx bx-plus"></i></a>
                    <a href="portfolio-details.html" className="portfolio-details-lightbox" data-glightbox="type: external" title="Portfolio Details"><i className="bx bx-link"></i></a>
                  </div>
                </div>
              </div>
            ...
            <div className="col-lg-4 col-md-6 portfolio-item filter-home">
              <div className="portfolio-wrap">
                <img src="assets/img/photos/IMG_7820.jpg" className="img-fluid" alt="" />
                <div className="portfolio-info">
                  <h4>Honey</h4>
                  <p>Home</p>
                  <div className="portfolio-links">
                    <a href="assets/img/photos/IMG_7820.jpg" data-gallery="portfolioGallery" className="portfolio-lightbox" title="Home"><i className="bx bx-plus"></i></a>
                    <a href="portfolio-details.html" className="portfolio-details-lightbox" data-glightbox="type: external" title="Portfolio Details"><i className="bx bx-link"></i></a>
                  </div>
                </div>
              </div>
            ...
            <div className="col-lg-4 col-md-6 portfolio-item filter-home">
              <div className="portfolio-wrap">
                <img src="assets/img/photos/IMG_7821.jpg" className="img-fluid" alt="" />
                <div className="portfolio-info">
                  <h4>Air Freshner</h4>
                  <p>Home</p>
                  <div className="portfolio-links">
                    <a href="assets/img/photos/IMG_7821.jpg" data-gallery="portfolioGallery" className="portfolio-lightbox" title="Home"><i className="bx bx-plus"></i></a>
                    <a href="portfolio-details.html" className="portfolio-details-lightbox" data-glightbox="type: external" title="Portfolio Details"><i className="bx bx-link"></i></a>
                  </div>
                </div>
              </div>
            ...
            <div className="col-lg-4 col-md-6 portfolio-item filter-home">
              <div className="portfolio-wrap">
                ...
                <div className="portfolio-info">
                  ...
                  <p>Home</p>
                  <div className="portfolio-links">
                    <a href="assets/img/portfolio/portfolio-6.jpg" data-gallery="portfolioGallery" className="portfolio-lightbox" title="Home"><i className="bx bx-plus"></i></a>
                    <a href="portfolio-details.html" className="portfolio-details-lightbox" data-glightbox="type: external" title="Portfolio Details"><i className="bx bx-link"></i></a>
                  </div>
                </div>
              </div>
            ...
            <div className="col-lg-4 col-md-6 portfolio-item filter-home">
              <div className="portfolio-wrap">
                <img src="assets/img/photos/IMG_7830.jpg" className="img-fluid" alt="" />
                <div className="portfolio-info">
                  <h4>Dark Chocolate</h4>
                  <p>Home</p>
                  <div className="portfolio-links">
                    <a href="assets/img/photos/IMG_7830.jpg" data-gallery="portfolioGallery" className="portfolio-lightbox" title="Home"><i className="bx bx-plus"></i></a>
                    <a href="portfolio-details.html" className="portfolio-details-lightbox" data-glightbox="type: external" title="Portfolio Details"><i className="bx bx-link"></i></a>
                  </div>
                </div>
              </div>
            ...
            <div className="col-lg-4 col-md-6 portfolio-item filter-home">
              <div className="portfolio-wrap">
                <img src="assets/img/photos/IMG_7815.jpg" className="img-fluid" alt="" />
                <div className="portfolio-info">
                  <h4>Flower</h4>
                  <p>Home</p>
                  <div className="portfolio-links">
                    <a href="assets/img/photos/IMG_7815.jpg" data-gallery="portfolioGallery" className="portfolio-lightbox" title="Home"><i className="bx bx-plus"></i></a>
                    <a href="portfolio-details.html" className="portfolio-details-lightbox" data-glightbox="type: external" title="Portfolio Details"><i className="bx bx-link"></i></a>
                  </div>
                </div>
              </div>
